...
def filter_messages(messages):
    ...
    for i in range(0, len(messages)):
        ...
        #PP print(f" my_list1_append after append = {my_list_append}")
        #PP print()
        # print(f" my_list1 after join {my_list_join}")
        ...
        #PP print()
        #PP print(f"my_list_join after join = {my_list_join}")
        ...
        #PP print(f"my_list_together is {my_list_together}")
        #PP print()
    ...
    ##  return final_message, real_message
    return real_message
...
# my_String = ["darn it", "this dang thing won't work", "lets fight one on one"]

# real_message = filter_messages(my_String)

#PP print()
#PP print("======================================================")
#PP print()

# print(f" my_list_append = {my_list_together}")
#PP print(my_String)
#PP print(final_message)
# print(real_message)
# print(f" my_list_join = {my_list_join}")
#PP print()
# print(f" my_list_count = {my_list_count}")
